...
typedef enum symtype {
	UNKNOWN,	 // 0) Type label for an Unknown Data Type
...
typedef struct sym {
	...
	SymType type;     // The Type label of Symbol.
	GenType value; // The Value contained in the Symbol. (Many need to change Data Type)
} Symbol;

extern void symtab_add(char* uid, char* scope, SymType type, GenType value);
